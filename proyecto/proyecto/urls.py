...
urlpatterns = patterns('',
    ...
    url(r'^cliente/cargo-lugar/$', 'clientes.views.cargo_lugar_cliente', name='cargo-lugar-cliente'),
    url(r'^localidades/cargo-ciudad/$', 'localidades.views.obtener_localidad', name='obtener-localidad'),
    url(r'^localidades/cargo-lugar/$', 'localidades.views.obtener_lugar', name='obtener-lugar'),
    url(r'^localidades/busco-lugar/$', 'localidades.views.busco_lugar', name='busco-lugar'),       
    ...
    url(r'^analitos/cate-analitos-pedidos/$', 'analitos.views.cate_analitos_pedidos', name='cate-analitos-pedidos'),
